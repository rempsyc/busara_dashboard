...
waffle_continent(articles.df4, citation)
...
waffle_continent_journal(articles.df4, citation)
...
### Waffle plot of journal paper percentages, by country (each flag = 1% of data) {data-height=600}

```{r country_table_overall, fig.width=4.5, fig.height=4.5}
waffle_country(articles.df4, citation)
...
### Scatter plot of journal paper percentages, by country and year {data-height=600}
...
waffle_country_journal(articles.df4, citation)
...
articles.df4_copy <- articles.df4
articles.df4 <- articles.df4 %>% 
  filter(field == "psychology")
...
articles.df4 <- articles.df4_copy %>% 
  filter(field == "economics")
...
missing_journals <- detect_missing_journals(articles.df4_copy)
missing_journals %>% 
  filter(found == FALSE)
...
table_journal_count(data = articles.df4_copy)

```

# Limitations {data-navmenu="Limitations"}

## Row 1 {data-height=700} {.tabset .tabset-fade}
