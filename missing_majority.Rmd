...
**Note that the big general journals (PloS One, Science, Nature, and PNAS) are only for reference and are not included in the _Behavioural Science Journals_ tab or on the home page gauge data. Furthermore, the _Behavioural Science Journals_ tab is simply a combination of the psychology and economics data.**
