...
stats_continent <- table_continent(data_not_gen, datatable = FALSE)
stats_country <- table_country(data_not_gen, datatable = FALSE)
```
...
```{r citations}
citation <- "Thériault, R., & Forscher, P. (2024). _The Missing Majority in Behavioural Science Dashboard_. <br>https\\://remi-theriault.com/dashboards/missing_majority"

citation2 <- 'Thériault, R., & Forscher, P. (2024). <i>The Missing Majority in Behavioural Science Dashboard</i>. <br>https://remi-theriault.com/dashboards/missing_majority'
```
