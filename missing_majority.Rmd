...
```{r stats_continent}
behavioural_science <- data %>% 
  filter(field != "general")

stats_continent <- table_continent(behavioural_science, datatable = FALSE)
stats_country <- table_country(behavioural_science, datatable = FALSE)
```
