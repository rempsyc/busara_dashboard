...
```{r psych_parent, child=c('missing_majority_psychology.Rmd')}
```

```{r econ_parent, child=c('missing_majority_economics.Rmd')}
```

```{r gen_parent, child=c('missing_majority_general.Rmd')}
```
