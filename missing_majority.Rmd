...
```{r psych_parent, child=c('missing_majority_psychology.Rmd'), eval=FALSE}
```

```{r econ_parent, child=c('missing_majority_economics.Rmd'), eval=FALSE}
```

```{r gen_parent, child=c('missing_majority_general.Rmd'), eval=FALSE}
```
