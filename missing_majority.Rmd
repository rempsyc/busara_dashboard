...
```{r citations}
citation <- "Thériault, R., & Forscher, P. (2024). _The Missing Majority in Behavioral Science Dashboard_. <br>https\\://remi-theriault.com/dashboards/missing_majority"

citation2 <- 'Thériault, R., & Forscher, P. (2024). <i>The Missing Majority in Behavioral Science Dashboard</i>. <br>https://remi-theriault.com/dashboards/missing_majority'
```
