...
# Continent {data-navmenu="All Fields"}
...
waffle_continent(data, citation, citation_size = 7)
...
# Continent, by Year {data-navmenu="All Fields"}
...
scatter_continent_year(as.data.frame(data), 
                       method = "loess",
                       ymin = 0,
                       ymax = 100,
                       yby = 20,
...
# Continent, by Journal {data-navmenu="All Fields"}
...
waffle_continent_journal(data, citation)
...
## Row 2 {data-width=680}

### Table of journal paper percentages, by continent and journal {data-width=1460}
...
# Country {data-navmenu="All Fields"}
...
waffle_country(data, citation, citation_size = 7)

```

## Row 2 {data-width=800}

### Table of journal paper percentages, by country {data-width=1460}
...
# Country, by Year {data-navmenu="All Fields"}
...
# Country, by Journal {data-navmenu="All Fields"}
...
waffle_country_journal(data, citation)
...
### Table of journal paper percentages, by country and journal {data-width=1460}
