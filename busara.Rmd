...
# Now we only include those from the official list because it seems we
# are getting A LOT of other journals
articles.df4 <- articles.df4 %>%
  filter(year >= 1987,
         journal %in% journal_field$journal)

# Note: the following journals are not available on PubMed:
...
The count of included journals is presented here:
