...
### Proportion of American First Authors 1987-Today
...
fig1 <- nice_scatter(df.us.journal.year,
             predictor = "year", 
  ...
  scale_colour_manual(values = rep("black", 6), name = "") +
  scale_shape_manual(values = c(18, 17, 17, 23, 19, 20), name = "") +
  scale_size_manual(values = c(2, 2, 4, 4, 4, 2), name = "") +
