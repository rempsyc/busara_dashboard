...
The full current list of journals queried can be obtained through the following R code `pubmedDashboard::journal_field$journal_short[-23]` (note that PLOS One [the "23"] was excluded because its number of papers is too large to handle for this dashboard):
