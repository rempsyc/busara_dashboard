...
<script>
   document.querySelector(".navbar-header").innerHTML =
            "<a href=\"#about\" class=\"navbar-brand navbar-inverse\">Neglected 95% Dashboard</a>";
</script> 
...
**[Rémi Thériault](https://remi-theriault.com/)** is currently a PhD candidate in Psychology at Université du Québec à Montréal, Canada. Overall, Rémi is passionate about putting social-psychological research to use to increase people’s well-being and intrinsic motivation to help one another. He also has a passion for programming with R.
