...
x <- table_continent_year(data_econ)
...
x <- table_continent_journal(data_econ)
...
x <- table_country_year(data_econ)
...
x <- table_country_journal(data_econ)
...
### Scatter plots of journal paper percentages, by journal, continent, and year {data-width=1200}
