...
```{r theming, include=FALSE, context = "server", eval=F}
bslib::bs_themer()
```
...
```{r clean_journals_continents, eval=F}
articles.df4 <- clean_journals_continents(articles.df4)
```

```{r exclude_other_journals, eval=F}
...
# Continent {data-navmenu="All Fields" .storyboard}

### Waffle plot of journal paper percentages, by continent (each square = 1% of data) {data-commentary-width=400}
